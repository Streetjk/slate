...
inline constexpr char kSsid0[]  = "ssid0";
inline constexpr char kPwd0[]   = "pwd0";
inline constexpr char kSsid1[]  = "ssid1";
inline constexpr char kPwd1[]   = "pwd1";
inline constexpr char kSsid2[]  = "ssid2";
inline constexpr char kPwd2[]   = "pwd2";
inline constexpr char kSsid3[]  = "ssid3";
inline constexpr char kPwd3[]   = "pwd3";
...
SLATE_NVS_ASSERT_NAME(net::kSsid0);
SLATE_NVS_ASSERT_NAME(net::kPwd0);
SLATE_NVS_ASSERT_NAME(net::kSsid1);
SLATE_NVS_ASSERT_NAME(net::kPwd1);
SLATE_NVS_ASSERT_NAME(net::kSsid2);
SLATE_NVS_ASSERT_NAME(net::kPwd2);
SLATE_NVS_ASSERT_NAME(net::kSsid3);
SLATE_NVS_ASSERT_NAME(net::kPwd3);
