...
## Campaign 8D1K-G12 final closure
...
G12 completed without a Gemini provider call. The durable exact-shape replay
passed through the Bun parent and mock Node child with synthetic text only;
