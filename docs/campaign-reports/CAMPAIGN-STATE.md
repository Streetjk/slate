...
PORTFOLIO_CURRENT_NODE=FRESH_GROK_4_6_REVIEW_OF_EXACT_C7_REPAIR_CANDIDATE
...
C8_READY=0
C8_READONLY_READY=1
C8_NEXT_ACTION=FRESH_GROK_4_6_REVIEW;NO_FIRMWARE_FLASH
...
C7_READY=0
C7_READONLY_READY=1
C7_NEXT_ACTION=FRESH_GROK_4_6_REVIEW_OF_C7_REPAIR;NO_BACKEND_DEPLOYMENT
...
PORTFOLIO_TERMINAL_REASON=FRESH_CANONICAL_GROK_REVIEW_PENDING;DEPLOYMENT_AND_FLASH_UNAUTHORIZED
PORTFOLIO_NEXT_ACTION=RETRY_grok_-m_grok-4.6;THEN_FREEZE_EXACT_ARTIFACT_IF_PASS
```
