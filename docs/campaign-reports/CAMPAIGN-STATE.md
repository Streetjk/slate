...
## Authoritative current frontier — reviewed app-only reflash PASS; physical M4 boundary

```text
CURRENT_HEAD_AT_CHECKPOINT=35c0de710e715a59edff478b652c12fe4af23d07
CURRENT_STAGE=M4_SECOND_FAIL_REVIEWED_APP_ONLY_REFLASH_PASS_PHYSICAL_SESSION_PENDING
...
CURRENT_BLOCKED_NODE=M4_COMBINED_PHYSICAL_EN_JA_SESSION
HUMAN_ACTION_REQUIRED=YES
HUMAN_ACTION_REASON=ONE_COMBINED_PHYSICAL_M4_EN_JA_VOICE_SESSION
TERMINAL_REASON=NONE_CAMPAIGN_CONTINUES
NEXT_ACTION=INGEST_ONE_COMBINED_PHYSICAL_M4_EN_JA_RESULT_THEN_CLOSE_OR_ATTRIBUTE_REPAIR
```
