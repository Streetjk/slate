...
## Authoritative portfolio C9 frontier — current official reconciliation complete; architecture/auth gate

```text
C9_LIVE_HEAD=906bdd889cb507db12a1fc3d195a9109e1b18d07
C9_BASE_SHA=2d4a2a9e9a380c591c2ac7f0f3120f1f7939b65d
C9_STAGE=READONLY_RESEARCH_RECONCILED_AGAINST_CURRENT_C8_RUNTIME
C9_HISTORICAL_SELECTION=VERTEX_ADC
C9_CURRENT_C8_RUNTIME=DEVELOPER_API_KEY;GEMINI_2_5_NATIVE_AUDIO;BACKEND_ONLY
C9_CURRENT_SDK=@google/genai_2.20.0
C9_SDK_AUTH_SURFACES=API_KEY;VERTEX_PROJECT_LOCATION;PUBLIC_GOOGLEAUTHOPTIONS
C9_DEVELOPER_OAUTH_LIVE_STATUS=DOCUMENTED_AUTH_SETUP;END_TO_END_NODE_LIVE_UNVERIFIED
C9_CURRENT_OFFICIAL_LIVE_SURFACE=GEMINI_3.1_FLASH_LIVE_PREVIEW
C9_TRANSCRIBE_LIVE_STATUS=DEDICATED_STT_ONLY;RESEARCH_ONLY
C9_LIVE_TRANSLATE_STATUS=TRANSLATION_ONLY;NOT_SLATE_ASSISTANT_REPLACEMENT
C9_SOURCE_OVERLAP_WITH_C8=23_ASSISTANT_AND_CONFIG_PATHS;NO_C9_SOURCE_CHANGE
C9_RUNTIME_IMPLEMENTATION=DEFERRED_UNTIL_C8_STABLE_REVIEWED_BOUNDARY
C9_PROVIDER_CALLS=0
C9_OAUTH_CONSENT=NOT_PERFORMED
C9_BILLING_CHANGE=NO
C9_PRODUCTION_CHANGE=NO
C9_FIRMWARE_CHANGE=NO
C9_READY=0
C9_READONLY_READY=0
C9_WAITING_DEVICE=0
C9_WAITING_HUMAN=1
...
This current research checkpoint supersedes the date-specific assumptions in
the legacy Campaign 6D state below, while retaining that state for historical
provenance. It does not select or activate a new runtime.
...
## Campaign 9 Gemini Runtime/Auth Architecture Checkpoint

```text
CAMPAIGN=9
PR=3
FEATURE_BRANCH=feature/gemini-runtime-auth-architecture
START_SHA=bbdfb2c08e49e8069ade7bb150c1f9df278f35e4
STATUS=PASS_RESEARCH_COMPLETE
PRODUCTION_RUNTIME=vertex_adc_RETAINED
DEVELOPER_OAUTH_ADC=DEFERRED_UNVERIFIED
DEVELOPER_API_NODE_SDK_OAUTH_LIVE=UNSUPPORTED_BY_INSTALLED_GENAI_2_20_0_PATH
DEVELOPER_FREE_TIER_QUOTA=NOT_VERIFIED_NO_LOCAL_ADC
DEVELOPER_LIVE_PROBES=NOT_RUN_NO_LOCAL_ADC
VERTEX_LATENCY_COMPARISON=NOT_MEASURED_NO_LIVE_CREDENTIALS
...
FIRMWARE_CHANGED=NO
FIRMWARE_FLASHED=NO
OUTLOOK_AI_ISOLATION=PRESERVED
GOOGLE_CALENDAR_CONFIRM_GATE=PRESERVED
AGY_REVIEW=PASS_GEMINI_3_7_FLASH_HIGH_WITH_ADVISORIES
AGY_PRODUCT_WRITES=NO
READY_FOR_GEMINI_RUNTIME_DEPLOY=false
REPORT=docs/campaign-reports/09-GEMINI-RUNTIME-AUTH-ARCHITECTURE.md
NEXT_ACTION=HUMAN_OAUTH_ADC_SETUP_FOR_OPTIONAL_NONPRODUCTION_DEVELOPER_PROBE_OR_RETAIN_VERTEX
```
