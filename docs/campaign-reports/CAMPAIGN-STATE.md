...
Current status: HARD_STOP_EXACT_FULL_ADAPTER_REAL_PROVIDER_REVALIDATION_FAILURE — F1 recovered the exact protected source without reading content; the one F2 call failed at the Slate adapter boundary and no retry is authorized.
