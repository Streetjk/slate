...
Current status: F1_PROTECTED_CREDENTIAL_SOURCE_RECOVERED — exact historical host-local protected source and read-only Docker destination verified without reading credential content; the single 8D1K-F provider call remains unspent.
