...
R8_STATUS=LIVE_PREFLIGHT_AND_EXACT_REMOTE_INSTALL_IN_PROGRESS
...
STATUS=V6_REVIEW_PASS_REMOTE_INSTALL_PENDING
NEXT_ACTION=INSTALL_EXACT_V6_VERIFY_AND_ARM_NONACTIVATING_OBSERVER
