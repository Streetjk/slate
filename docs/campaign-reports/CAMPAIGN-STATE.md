...
## Current active checkpoint — Campaign 8D1M-G frontier exhausted at C1 review policy boundary

```text
CAMPAIGN=8D1M_G_UX_FIX_DEPLOY_AND_PHYSICAL_RETEST
STATUS=C2_REVIEWED_V2_INSTALLED_OBSERVER_ARMED_MANUAL_SUDO_PENDING
...
M2_STATUS=CONTAINERD_MIGRATION_MANUAL_SUDO_PENDING_AFTER_C1_REVIEW_PASS
...
NEXT_ACTION=RUN_ONE_MANUAL_SUDO_CONTAINERD_NVME_MIGRATION
