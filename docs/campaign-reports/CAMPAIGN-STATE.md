...
## Authoritative current frontier — lower WebSocket transport event-loss window proven; AGY repair recovery

```text
CURRENT_HEAD_AT_CHECKPOINT=95a037d5cee707df654ad1609e1aba81ff23f6e0
CURRENT_STAGE=M4_SECOND_FAIL_LOWER_WEBSOCKET_CALLBACK_ORDER_PROVEN_AGY_RECOVERY
...
ZAI_REVIEW_STATUS=NOT_REQUIRED_UNCHANGED_CURRENT_BYTES
...
NEXT_ACTION=RECOVER_SAME_AGY_WRITER_ROUTE_THEN_APPLY_MINIMAL_PRE_CONNECT_CALLBACK_REPAIR
```
