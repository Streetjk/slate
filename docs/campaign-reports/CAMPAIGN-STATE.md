...
## Current active checkpoint — Campaign 8D1M-G frontier scan F1 correction pending review

```text
CAMPAIGN=8D1M_G_UX_FIX_DEPLOY_AND_PHYSICAL_RETEST
STATUS=FRONTIER_SCAN_F1_V2_CORRECTION_PENDING_EXACT_REVIEW
...
NEXT_ACTION=CONTINUE_F2_F3_F4_F5_READONLY_FRONTIER
