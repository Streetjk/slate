...
## Authoritative current frontier — exact ZAI review blocked by existing authentication

```text
CURRENT_HEAD_AT_CHECKPOINT=cc2ee3a62473015aea8b81e7bd28479e89cd630e
...
HUMAN_ACTION_REASON=RESTORE_EXISTING_DESIGNATED_ZAI_GLM53_REVIEW_AUTH_OUT_OF_BAND; NO_CREDENTIAL_REPLACEMENT_AUTHORIZED
TERMINAL_REASON=NONE_CAMPAIGN_CONTINUES
NEXT_ACTION=AFTER_EXISTING_ZAI_AUTH_RESTORED_RUN_FRESH_EXACT_REVIEW_THEN_APP_ONLY_REFLASH_IF_PASS
```
