...
## Authoritative current frontier — R9 PASS, C3 exact image load

```text
CURRENT_HEAD_AT_R9_START=fbc080c49b8cec912cf42364c8a48fcaec3b7422
CURRENT_STAGE=R9_POST_ROOT_VERIFICATION_PASS_C3_LOAD_PENDING
PR_NUMBER=2
PR_STATE=OPEN
PR_DRAFT=YES
PR_MERGED=NO
...
NEXT_ACTION=LOAD_EXACT_C3_ARM64_IMAGE_AND_RUN_PROVIDER_DISABLED_PREDEPLOY_GATE
```
