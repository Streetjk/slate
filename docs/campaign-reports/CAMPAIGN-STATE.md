...
## Authoritative current frontier — bounded provider qualification consumed at session setup failure; no retry authority

```text
CURRENT_HEAD=1edf33e578030c60d12a20b04ea271b58266195d
CURRENT_STAGE=M4_ONE_BOUNDED_PROVIDER_QUALIFICATION_FAIL_SESSION_SETUP_NO_RETRY
...
CURRENT_BLOCKED_NODE=M4_PROVIDER_SESSION_SETUP_FAILURE_NO_RETRY_AUTHORITY
HUMAN_ACTION_REQUIRED=YES
HUMAN_ACTION_REASON=NO_PROVIDER_RETRY_AUTHORIZED_AFTER_CONSUMED_SESSION;NEW_PROVIDER_AUTHORITY_REQUIRED_FOR_FURTHER_PROVIDER_DIAGNOSIS;NO_PHYSICAL_ACTION_REQUESTED
TERMINAL_REASON=PROVIDER_SESSION_SETUP_FAILURE_WITH_NO_RETRY_AUTHORITY
NEXT_ACTION=CONTINUE_ZERO_PROVIDER_DIAGNOSIS;DO_NOT_REQUEST_PROVIDER_RETRY_OR_PHYSICAL_TEST_UNTIL_A_NEW_EXACT_BOUNDARY_IS_JUSTIFIED
```
