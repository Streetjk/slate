...
## Authoritative current frontier — AGY WebSocket repair qualified; fresh ZAI review required

```text
CURRENT_HEAD_AT_CHECKPOINT=95a037d5cee707df654ad1609e1aba81ff23f6e0
CURRENT_STAGE=M4_SECOND_FAIL_AGY_WEBSOCKET_CALLBACK_REPAIR_QUALIFIED_REVIEW_PENDING
...
ZAI_REVIEW_STATUS=PENDING_FRESH_EXACT_REVIEW_CHANGED_BYTES
...
NEXT_ACTION=FRESH_EXACT_ZAI_GLM53_REVIEW_OF_REPAIRED_SOURCE_AND_FIRMWARE
```
