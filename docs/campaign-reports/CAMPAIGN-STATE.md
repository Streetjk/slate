...
## Current active checkpoint — Campaign 8D1M-G M2 containerd recovery C1 review pending

```text
CAMPAIGN=8D1M_G_UX_FIX_DEPLOY_AND_PHYSICAL_RETEST
STATUS=M2_C1_GROK_REVIEW_PENDING
...
M2_STATUS=CONTAINERD_RECOVERY_C1_REVIEW_PENDING
...
NEXT_ACTION=EXACT_GROK_REVIEW_BEFORE_MANUAL_SUDO
...
C1_GROK_REVIEW=REQUIRED_BEFORE_MANUAL_SUDO
```
