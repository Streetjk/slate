...
## Authoritative portfolio C7 frontier — software revalidated; deployment/physical gate

```text
C7_LIVE_HEAD=0a985ab5c18596310290a1ff4da4b4d7b585d947
C7_BASE_SHA=2d4a2a9e9a380c591c2ac7f0f3120f1f7939b65d
C7_CURRENT_BASE=2d4a2a9e9a380c591c2ac7f0f3120f1f7939b65d
...
C7_WA_HOLIDAY_SOURCE_AS_OF=2026-09-10;WA_GOV_LAST_UPDATED_2026-09-02;CONFIRMED_2026_2027
C7_OPEN_METEO_LIVE_PROBE=HTTP_200
C7_GOOGLE_NEWS_AU_PROBE=HTTP_200;APPLICATION_XML
C7_GOOGLE_NEWS_TW_PROBE=HTTP_200;APPLICATION_XML
...
The portfolio reconciliation above supersedes the legacy Campaign 6D state
below for Campaign 7 scheduling. Historical Campaign 6D records are retained
for provenance and are not claimed as Campaign 7 acceptance.
...
## Campaign 7 Feature Branch Checkpoint — PR #1

```text
CAMPAIGN=7
FEATURE_BRANCH=feature/perth-calendar-weather-google-news
BASE_SHA=2d4a2a9e9a380c591c2ac7f0f3120f1f7939b65d
IMPLEMENTATION_HEAD=fb45b794baf02b0ad8b367755a83a25c4af29308
STATUS=PASS_SOFTWARE_READY_FOR_HUMAN_PR_REVIEW
AGY_VERDICT=PASS_AFTER_ONE_REVISE_CYCLE
AGY_MODEL=gemini-3.7-flash-medium
DETERMINISTIC_TESTS=283_PASS_0_FAIL
FIRMWARE_TOUCHED=NO
CAMPAIGN6D_TOUCHED=NO
ORANGE_PI_DEPLOYED=NO
