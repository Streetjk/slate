...
## Current active checkpoint — Campaign 8D1M-G C2 D0 attribution complete, systemd-only observer armed

```text
CAMPAIGN=8D1M_G_UX_FIX_DEPLOY_AND_PHYSICAL_RETEST
STATUS=C2_OBSERVER_INTERFERENCE_PROVEN_SYSTEMD_OBSERVER_ARMED_MANUAL_SUDO_PENDING
...
M2_STATUS=CONTAINERD_MIGRATION_MANUAL_SUDO_PENDING_AFTER_D0_OBSERVER_RECOVERY
...
NEXT_ACTION=RUN_ONE_MANUAL_SUDO_CONTAINERD_NVME_MIGRATION_WITH_SYSTEMD_ONLY_OBSERVER
...
C2_STATUS=SYSTEMD_ONLY_OBSERVER_ARMED_MANUAL_SUDO_PENDING
...
E2_STATUS=ONE_COMBINED_MANUAL_SUDO_COMMAND_READY
E2_V2_EXECUTION=NOT_YET
```
