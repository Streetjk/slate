...
## Authoritative portfolio frontier — C8 stable; C7 combined candidate reviewed PASS

```text
PORTFOLIO_MODE=PORTFOLIO_FRONTIER_DRIVEN_LONGRUN
PORTFOLIO_HEAD_OR_COORDINATION_SHA=f3e38a5a16420dae5ed3386607090a47c127c768
PORTFOLIO_CURRENT_PRIORITY=C8_STABLE_THEN_C7_AUTHORITY_BOUNDARY
PORTFOLIO_CURRENT_CAMPAIGN=C7
PORTFOLIO_CURRENT_NODE=EXACT_COMBINED_C7_C8_DEPLOYMENT_AND_ONE_PHYSICAL_NOTE4_ACCEPTANCE_AUTHORITY
...
C8_NEXT_HUMAN_AUTHORITY=EXACT_COMBINED_C7_C8_BACKEND_DEPLOYMENT_AND_ONE_PHYSICAL_NOTE4_EN_JA_ACCEPTANCE
