...
## Authoritative current frontier — post-reflash attribution blocked by observer value gap

```text
CURRENT_HEAD_AT_CHECKPOINT=1bc9cd700304c6260cd4e8adcee6bfaddc09b4f2
CURRENT_STAGE=M4_POST_REFLASH_OBSERVER_VALUE_CAPTURE_REPAIR_PENDING
...
CURRENT_BLOCKED_NODE=OBSERVER_VALUE_CAPTURE_REPAIR
HUMAN_ACTION_REQUIRED=NO
HUMAN_ACTION_REASON=NONE
TERMINAL_REASON=NONE_CAMPAIGN_CONTINUES
NEXT_ACTION=RUN_DURABLE_OBSERVER_SELF_TEST_REARM_SANITIZED_OBSERVER_THEN_REATTRIBUTE_WITHOUT_PHYSICAL_RETRY
```
