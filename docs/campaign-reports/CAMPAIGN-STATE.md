...
## Authoritative current frontier — exact ZAI review PASS; app-only reflash pending

```text
CURRENT_HEAD_AT_CHECKPOINT=64da79faaf0cc7dadeaadd3620a7640d0a1566e8
CURRENT_STAGE=M4_SECOND_FAIL_ZAI_EXACT_REVIEW_PASS_APP_ONLY_REFLASH_PENDING
...
FLASH_STATUS=PENDING_EXACT_APP_ONLY_REFLASH
...
NEXT_ACTION=VERIFY_NOTE4_IDENTITY_THEN_APP_ONLY_FLASH_EXACT_REVIEWED_FIRMWARE
```
