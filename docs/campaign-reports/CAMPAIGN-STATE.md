...
## Current active checkpoint — Campaign 8D1M-G M2 exact reviewer transport hard stop

```text
CAMPAIGN=8D1M_G_UX_FIX_DEPLOY_AND_PHYSICAL_RETEST
STATUS=M2_C1_GROK_REVIEW_TRANSPORT_HARD_STOP
...
NEXT_ACTION=RETAINED_GROK_EXACT_REVIEW_TRANSPORT_HARD_STOP
