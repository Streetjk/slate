...
## M0 — activated feasibility and retained root-authority boundary

The operator's explicit `proceed` activated this proposal. M0 was completed
read-only. The migration is feasible on storage, but M1 cannot begin without
host-root authority to stop Docker, copy `/var/lib/docker` faithfully, and
change the daemon data-root reversibly.

```text
REMOTE_HEAD_AT_M0=8146708ed8f666f142cf781f27383e88cefa2d68
PR2_STATE=open
PR2_DRAFT=true
PR2_MERGED_AT=null
SOURCE_SHA=aae1c1fefce5e6c4ca4dbc2cd4d50f44ed4863d3
...
DOCKER_ROOT_TREE_READ_ONLY=PASS
DOCKER_DAEMON_CONFIG=ABSENT_DEFAULT_CONFIGURATION
NVME_PATH=/mnt/ssd-tmp
...
DOCKER_DAEMON=active_enabled
ROOT_SSH=UNAVAILABLE
SUDO_NONINTERACTIVE=UNAVAILABLE
M1_DAEMON_STOP=NOT_RUN
M1_DOCKER_ROOT_COPY=NOT_RUN
M1_DAEMON_RECONFIGURATION=NOT_RUN
PRODUCTION_CHANGED=NO
