...
## Final nonphysical checkpoint — requalified and waiting for one combined acceptance session

```text
CURRENT_HEAD=7f02b530d882ebbc3b9ed2728148bc6875aafea0
...
PROVIDER_FIRST_OUTPUT_EVENT=NOT_OBSERVED_IN_PRE_INSTRUMENTED_SESSION
BACKEND_FIRST_AUDIO_PACKET_TO_DEVICE=NOT_OBSERVED_IN_PRE_INSTRUMENTED_SESSION
FIRMWARE_FIRST_AUDIO_PACKET_RECEIVED=NOT_OBSERVED_IN_PRE_INSTRUMENTED_SESSION
FIRMWARE_FIRST_DECODED_PCM=NOT_OBSERVED_IN_PRE_INSTRUMENTED_SESSION
AUDIO_PLAYER_FIRST_WRITE=NOT_OBSERVED_IN_PRE_INSTRUMENTED_SESSION
...
LATENCY_BUCKETS=ALL_UNAVAILABLE_FOR_INGESTED_SESSION;NEW_BACKEND_AND_FIRMWARE_NUMERIC_MARKERS_DEPLOYED
...
AUDIO_CHAIN_STATUS=MIC_INGRESS_AND_PROVIDER_SESSION_ESTABLISHED;NO_DOWNSTREAM_MARKERS_RETAINED;PHYSICAL_AUDIBILITY_UNKNOWN
AUDIO_NONPHYSICAL_CHAIN_STATUS_KNOWN=YES_STRUCTURAL_DOWNSTREAM_STATUS_UNKNOWN_AND_EXPLICITLY_OPEN
AUDIO_ACCEPTANCE=OPEN_FOR_COMBINED_PHYSICAL_ACCEPTANCE
ZAI_REVIEW_ROUTE=zai-glm53-reviewer
ZAI_REVIEW_MODEL=glm-5.3-flash
ZAI_REVIEW_TARGET_SHA=7acb8b96a02130dd0de8b21bc39e3fc43355da5f
ZAI_REVIEW_VERDICT=PASS_NO_P0_P1_P2_NO_SECURITY_FINDINGS
BACKEND_DEPLOYMENT=PASS_TAG_SLATE_M4_SLOW_TURN_ORDER_JP_7ACB8B9
BACKEND_DEPLOYED_IMAGE_ID=sha256:35f5c510a54e53784dde56c2b7377bf6850cf3eed4bcdcc34a32d2f113d80cdf
BACKEND_DEPLOYMENT_SECRET_DESTINATION=/run/secrets/gemini_api_key
BACKEND_DEPLOYMENT_SECRET_MOUNT_RW=false
BACKEND_PROVIDER_DISABLED_ADAPTER_TEST=PASS_6_0_FAIL_16_EXPECTS_IN_DEPLOYED_CONTAINER
...
APP_ONLY_REFLASH=PASS_OFFSET_0x10000_ESPTOOL_5.2.0_HASH_VERIFIED
APP_ONLY_REFLASH_FIRMWARE_SHA256=4ea31710c6dfd5bff025b5282f2dd5edd49117eacfe4161988dcde0df820c298
OBSERVER_REARMED=YES
OBSERVER_PORT=/dev/cu.usbmodem31101
OBSERVER_RAW_CONTENT=NOT_RETAINED
OBSERVER_POST_REFLASH_FATAL_COUNT=0
READY_NODE_COUNT=0
...
HUMAN_ACTION_REASON=ONE_COMBINED_EN_JA_INSTRUMENTED_PHYSICAL_M4_SESSION
TERMINAL_REASON=PHYSICAL_BOUNDARY_ONLY
NEXT_ACTION=RUN_ONE_COMBINED_EN_JA_VOICE_AI_SESSION;REPORT_NUMERIC_LATENCY_CHAIN_TURN_ORDER_JP_GLYPHS_AND_AUDIBLE_AUDIO
```

The malformed first write invocations were rejected before any write; the
successful flash used only the authorized app range and exact readback hash
verification. The corrected observer was briefly booted out only to release
the serial port for flashing, then re-submitted under the same label and
verified armed. No new provider session was initiated during requalification.
