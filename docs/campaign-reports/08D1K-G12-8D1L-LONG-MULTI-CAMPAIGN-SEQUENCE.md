...
G13 was attempted exactly once. It reached bridge-ready through the accepted
source/image lineage, then timed out waiting for a model event and turn
completion. No retry is permitted by the authorization checkpoint; 8D1L and
8D1M were not started.
